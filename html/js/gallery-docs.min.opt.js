        ...
        c.docReady(function () {
          ...
          j.forEach(function (a) {
            ...
            try {
              ...
              return void (
                d &&
                d.error("Error parsing " + g + " on " + a.className + ": " + h)
              );
            }
            var i = new b(a, c);
            l && l.data(a, e, i);
    ...
    (l.ontransitionend = function (a) {
      if (a.target === this.element) {
        ...
        if (
          ...
          d(b.ingProperties) && this.disableTransition(),
          c in b.clean &&
...
!(function (a) {
      ...
      return (
        ...
        this.each(function () {
          function c() {
            if (H) {
              ...
              d
                ...
                L.css("left", B.find(".gallery-cover").css("left")).removeClass(
                  "dh ep"
                ),
                Y(),
                ...
                setTimeout(function () {
                  if (
                    (a(window).off("resize", z),
                    K.find(".gallery-body").css("display", "none"),
                    P && P.find(R).removeClass("k"),
                    a("nav").removeClass("ed"),
                    a("#placeholder-navbar").fadeOut(
                      b.outDuration,
                      "easeInQuad",
                      function () {
                        a(this).remove();
                    ...
                    K.css({
                      ...
                      "-webkit-transition":
                        "-webkit-transform " + b.outDuration / 1e3 + "s " + T,
                    });
                    var i = n.top - Q - S;
                    N.css({
                      ...
                      "-webkit-transition":
                        "-webkit-transform " + b.outDuration / 1e3 + "s",
                    });
                    var j = {};
                    F && D
                      ? ((j.width = l),
                        ...
                        X.css({ background: "" }))
                      : ((j.transform =
                          "translate3d(" + (n.left - y - S) + "px, 0, 0)"),
                        (j.transition =
                          "transform " + b.outDuration / 1e3 + "s " + T),
                        (j["-webkit-transition"] =
                          "-webkit-transform " +
                          b.outDuration / 1e3 +
                          "s " +
                  ...
                  A = setTimeout(function () {
                    a("body").css("overflow", ""),
                      ...
                      L.removeAttr("style").attr("style", C),
                      N.removeAttr("style"),
                      M.removeAttr("style"),
                      ...
                      K.removeClass("k"),
                      (G = !0),
                      a(".gallery").data("masonry") &&
                        a(".gallery").masonry("layout");
                  }, b.outDuration);
                }, 0);
            }
          }
          var d,
            ...
            B,
            C,
            D = a(this).attr("data-fillScreen") || b.fillScreen,
          ...
          (e = K.children(".placeholder").first()),
            e.length ||
              (K.wrapInner(a('<div class="placeholder"></div>')),
              (e = K.children(".placeholder").first()));
          var X = L.find(".gradient").first();
          D &&
            (X.length || ((X = a('<div class="gradient"></div>')), L.append(X)),
            K.attr("data-fillscreen", !0));
          var Y = function () {
              (L = K.find(".gallery-cover")),
                (M = K.find(".gallery-header")),
                (N = K.find(".gallery-curve-wrapper")),
                (O = K.find(".gallery-body")),
                (P = K.find(".gallery-action")),
                (e = K.find(".placeholder"));
            },
            Z = function () {
              (origContainerRect = K[0].getBoundingClientRect()),
                (f = origContainerRect.width),
                (g = K.height()),
                (h = M[0].getBoundingClientRect()),
                (i = h.width),
                (j = h.height),
                (l = L.width()),
                (m = L.height()),
          ...
          K.off("click.galleryExpand").on("click.galleryExpand", function (o) {
            ...
            var Y,
              ...
              aa,
              ba,
              ca = K.find(".gallery-cover").height(),
              da = function () {
                if (
                  ((V = window.innerWidth),
                  (W = window.innerHeight),
                  (d = V <= b.responsiveThreshold),
                  (F = l > V / 2 || D),
                  (Q = d ? 56 : 64),
                  (r = -K[0].getBoundingClientRect().top),
                  (s =
                    void 0 === s
                      ? -e[0].getBoundingClientRect().left
                      : s + -e[0].getBoundingClientRect().left),
                  (t = Math.round(ca / 2 + S + Q)),
                  (Y = ca / 2 - S),
                  ($ = Math.min(0.7 * V, U)),
                  (_ = W - Y - Q),
                  (y = Math.max((V - $) / 2, S)),
                  d ? (($ = V), (y = 0), (S = 20)) : (S = b.contentPadding),
                  F)
                )
                  if (D) {
                    ...
                    (p = Math.min(V, c)),
                      (q = Math.min(W - Q, imgHeight)),
                      (t = d ? Math.round((W - Q) / 2) : Math.round(3 * S + Q)),
                      (Y = q - t + Q),
                      (_ = W - t);
                  } else {
                    var k = f / g;
            ...
            da(),
              ...
              K.css({ height: g, width: f }),
              (C = L.attr("style"));
            var ea = function () {
              var a = "translate3d(";
              D
                ? (a += n.left + "px, " + S + "px, 0)")
                : (L.css({ left: y + S, top: S }),
                  (a += n.left - y - S + "px, 0, 0)")),
                L.css({ height: m, width: l, transform: a });
            };
            ea();
            var fa = n.top - Q - S;
            N.css({
              ...
              K.addClass("k"),
              "absolute" !== K.css("position") &&
                K.css({ position: "relative" }),
              (I = !0),
              (J = !1);
            var ga = a("#placeholder-overlay");
            ga.length ||
              ((ga = a('<div id="placeholder-overlay"></div>')), e.prepend(ga)),
              ga
                .off("click.galleryExpand")
            ...
            if (
              ...
              (ma.onload = function () {
                ...
                (ma.src = K.find("img").attr("src"));
              try {
                (v = u.getPalette(K.find("img")[0], 2)),
                  (w = "rgb(" + v[0][0] + "," + v[0][1] + "," + v[0][2] + ")"),
                  (x = "rgb(" + v[1][0] + "," + v[1][1] + "," + v[1][2] + ")"),
                  ha.css({ backgroundColor: x });
              } catch (o) {
                console.log(
                ...
                if (na.length) {
                  ...
                  if (ma.length) {
                    ...
                    (oa = Math.round(pa.width)),
                      (imgHeight = Math.round(pa.height));
                  }
                  na[0].getContext("2d").canvas.width === oa &&
                    na[0].getContext("2d").canvas.height === imgHeight &&
                    na.remove();
                }
              }
              ga.css({ backgroundColor: w }),
                D &&
                  X.length &&
                  X.css({
                    background:
            ...
            if (
              ((qa.transform = ""),
              (qa.transition = "transform " + b.inDuration / 1e3 + "s"),
              (qa["-webkit-transition"] =
                "-webkit-transform " + b.inDuration / 1e3 + "s"),
              F)
            )
              if (D) {
                (qa.width = p),
            ...
            L.css(qa),
              N.css({
                ...
                "-webkit-transition":
                  "-webkit-transform " + b.inDuration / 1e3 + "s " + T,
                transform: "",
              }),
            ...
            ra(),
              O.length &&
                (O.css({ marginTop: t, padding: S, minHeight: W - t }),
                D ||
                  (d
                    ? O.find(".title-wrapper").css({ marginTop: t / 2 })
                    : O.find(".title-wrapper").css({
                        marginLeft: l,
                        paddingLeft: S,
                        height: Y,
              ...
              (A = setTimeout(function () {
                ...
                O.length
                  ...
                  (J = !0),
                  (H = !0),
                  "function" == typeof b.onShow && b.onShow.call(this, K);
              }, b.inDuration));
          }),
  ...
  a.fn.galleryExpand = function (c) {
    return b[c]
      ...
      : "object" != typeof c && c
      ? void a.error("Method " + c + " does not exist on jQuery.galleryExpand")
  ...
  (function (a) {
    a(function () {
      ...
      if (b.length) {
        ...
        c.each(function () {
          ...
          b.on("click", function () {
            ...
            a(".c .gallery-expand").addClass("cb").stop().fadeIn(100),
              "all" !== d &&
                a(".c .gallery-expand")
                  .not("." + d)
                  .hide()
                  .removeClass("cb"),
              $masonry.masonry({ transitionDuration: ".3s" }),
      ...
      a(".carousel").carousel({ dist: 0, padding: 10 }),
      ...
      a(".gallery-expand").galleryExpand({ onShow: d }),
        a(".blog .gallery-expand").galleryExpand({ onShow: d, fillScreen: !0 }),
        a(".gallery-expand.fill-screen").galleryExpand({
          onShow: d,
          fillScreen: !0,
        });
      var e = a(".table-of-contents");
      e.pushpin({ top: e.offset().top }), a(".scrollspy").scrollSpy();
    });
  })(jQuery);
