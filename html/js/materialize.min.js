            ...
            init: function (b) {
                ...
                return (
                    ...
                    this.each(function () {
                        ...
                        b.swipeable &&
                            i > b.responsiveThreshold &&
                            (b.swipeable = !1),
                            (c = a(j.filter('[href="' + location.hash + '"]'))),
                            0 === c.length &&
                                (c = a(this).find("li.tab a.active").first()),
                            0 === c.length &&
                                (c = a(this).find("li.tab a").first()),
                            c.addClass("active"),
                            (n = j.index(c)),
                            n < 0 && (n = 0),
                            void 0 !== c[0] &&
                                ((d = a(c[0].hash)), d.addClass("active")),
                            h.find(".indicator").length ||
                        ...
                        this.each(function () {
                            ...
                            if (!a.isEmptyObject(e)) {
                                ...
                                d
                                    ...
                                    .on("keyup.autocomplete", function (g) {
                                        if (
                                            ((f = 0),
                                            13 !== g.which &&
                                                38 !== g.which &&
                ...
                a(this).each(function () {
                    ...
                    if (!d.hasClass("browser-default")) {
                        ...
                        d.before(q),
                            ...
                            q.after(i),
                            d.is(":disabled") ||
                                q.dropdown({ hover: !1, closeOnClick: !1 }),
                            d.attr("tabindex") &&
    ...
    (function (a) {
        ...
        a(document).ready(function () {
            ...
            (a.fn.material_chip = function (c) {
                ...
                var e = a.extend({}, b, c);
                (d.hasAutocomplete = !a.isEmptyObject(e.autocompleteData)),
                    (this.init = function () {
                        var b = 0;
                        d.$el.each(function () {
                            var c = a(this),
                    ...
                    (this.chips = function (b, c) {
                        ...
                        g.length &&
                            (g.attr("for", c),
                            b.data("chips").length && g.addClass("active"));
                        var h = a("#" + c);
                        d.hasAutocomplete &&
                            h.autocomplete({
                    ...
                    this.each(function () {
                        function c() {
                            "undefined" != typeof window.ontouchstart &&
                                (J[0].addEventListener("touchstart", l),
                                J[0].addEventListener("touchmove", m),
                                J[0].addEventListener("touchend", n)),
                                J[0].addEventListener("mousedown", l),
                                J[0].addEventListener("mousemove", m),
                                J[0].addEventListener("mouseup", n),
                                J[0].addEventListener("mouseleave", n),
                                J[0].addEventListener("click", j);
                        }
                        function d(a) {
                            return a.targetTouches &&
                        ...
                        function g(c) {
                            var d,
                                ...
                                l = s;
                            if (
                                ((r = "number" == typeof c ? c : r),
                                (s = Math.floor((r + u / 2) / u)),
                                (g = r - s * u),
                                (h = g < 0 ? 1 : -1),
                                (i = (-h * g * 2) / u),
                                (e = v >> 1),
                            ...
                            for (
                                (!b.noWrap || (s >= 0 && s < v)) &&
                                    ((j = o[f(s)]),
                                    a(j).hasClass("active") ||
                                        (J.find(".carousel-item").removeClass(
                                            "active"
                                        ),
                                        a(j).addClass("active")),
                                    (j.style[C] =
                            ...
                            if (
                                ((!b.noWrap || (s >= 0 && s < v)) &&
                                    ...
                                    (j.style.opacity = tweenedOpacity),
                                    (j.style.display = "block")),
                                l !== s && "function" == typeof b.onCycleTo)
                            ) {
                        ...
                        function i() {
                            ...
                            z &&
                                ((a = Date.now() - E),
                                (c = z * Math.exp(-a / b.duration)),
                                c > 2 || c < -2
                                    ? (g(A - c), requestAnimationFrame(i))
                                    : g(A));
                        }
                        function j(c) {
                            if (G)
                        ...
                        function k(a) {
                            ...
                            b.noWrap ||
                                (c < 0
                                    ? Math.abs(c + v) < Math.abs(c) && (c += v)
                                    : c > 0 && Math.abs(c - v) < c && (c -= v)),
                                c < 0
                                    ? J.trigger("carouselNext", [Math.abs(c)])
                                    : c > 0 && J.trigger("carouselPrev", [c]);
                        }
                        function l(a) {
                            (t = !0),
                                (G = !1),
                        ...
                        if (b.fullWidth) {
                            ...
                            L.length
                                ? (imageHeight = L.on("load", function () {
                                      J.css("height", a(this).height());
                                  }))
                                : ((imageHeight = J.find(".carousel-item")
                                      .first()
                                      .height()),
                                  J.css("height", imageHeight)),
                                K &&
                                    J.find(".carousel-fixed-item").addClass(
                                        "with-indicators"
                                    );
                        }
                        J.addClass("initialized"),
                            ...
                            (r = A = 0),
                            (o = []),
                            (p = J.find(".carousel-item").first().innerWidth()),
                            (q = J.find(".carousel-item")
                                .first()
                                .innerHeight()),
                            (u = 2 * p + b.padding),
                            J.find(".carousel-item").each(function (b) {
