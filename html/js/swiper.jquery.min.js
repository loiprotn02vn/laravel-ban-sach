            ...
            if (
                ...
                (T.container[0].swiper = T),
                    ...
                    (T.lockSwipes = function () {
                        (T.params.allowSwipeToNext = T.params.allowSwipeToPrev =
                            !1),
                    ...
                    (T.updateSlidesProgress = function (e) {
                        if (
                            ...
                            "undefined" ==
                                typeof T.slides[0].swiperSlideOffset &&
                                T.updateSlidesOffset();
                            var a = -e;
                            T.rtl && (a = e),
                ...
                (T.onTouchStart = function (e) {
                    if (
                        ...
                        if (
                            T.params.noSwiping &&
                            n(e, "." + T.params.noSwipingClass)
                        )
                            return void (T.allowClick = !0);
                        if (
                            !T.params.swipeHandler ||
                            n(e, T.params.swipeHandler)
                        ) {
                    ...
                    (T.onTouchEnd = function (e) {
                        if (
                            ...
                            for (
                                ...
                                "undefined" !=
                                typeof T.slidesGrid[v + T.params.slidesPerGroup]
                                    ? r >= T.slidesGrid[v] &&
                                      r <
                                          T.slidesGrid[
                                              v + T.params.slidesPerGroup
                            ...
                            function s(a) {
                                (e =
                                    ...
                                    "slide" === T.params.controlBy &&
                                        ...
                                        (i = -T.controller.spline.interpolate(
                                            -e
                                        ))),
